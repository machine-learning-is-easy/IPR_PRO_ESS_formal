...
rem
rem    $Revision: 1.18.4.13 $  $Date: 2009/12/07 20:19:15 $
rem
rem ********************************************************************
...
set COMPFLAGS=-MD -c -Zp8 -G5 -GX -W3 -nologo
set CPPCOMPFLAGS=-MD -c -Zp8 -G5 -W3 -nologo -Zm500 -GX -I"%MATLAB%\extern\include\win32" -DMSVC -DIBMPC
set DLLCOMPFLAGS=-MD -c -Zp8 -G5 -GX -W3 -nologo -I"%MATLAB%\extern\include\win32" -DMSVC -DIBMPC
set NAME_OBJECT=/Fo
